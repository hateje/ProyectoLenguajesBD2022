                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            ...
                            Value="<?php echo $Usuario["Cedula"]; ?>" required readonly="true">
                        </div>
                        <div class="col-3">
                            Contraseña
                            <input type="text" name="txtContrasenna" class="form-control" 
                            Value="<?php echo $Usuario["Contrasenna"]; ?>" required>
                        </div>
                        <div class="col-3">
                            Nombre
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            ...
                            <select name="txtRol" class="form-control" required>
                                <?php
                                    ConsultarRolesUsuario($Usuario["IdRol"]);
                                ?>
                            </select>
                        </div>
                        <div class="col-3">
