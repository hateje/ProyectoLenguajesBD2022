...
/
--Funcion para saber el vehÃ­culo mÃ¡s alquilado
...
/
/*FALTA DEPURARLO:*/
/*********STORED PROCEDURE PARA TOTAL DE FACTURA*******/
/*CREATE OR REPLACE FUNCTION TOTALFACTURA (pID number)
RETURN DECIMAL;
IS
  TOTAL DECIMAL;
BEGIN
...
CREATE OR REPLACE TRIGGER TGR_ACTUALIZA_PRECIO
AFTER INSERT ON PROYECTO.DETALLEFACTURA
FOR EACH ROW
DECLARE
    BEGIN
